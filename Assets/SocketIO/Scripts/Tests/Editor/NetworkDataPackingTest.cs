...
public class NetworkDataPackingTest
{
    ...
    private string expectedJSON = @"{""intField"":[0,1],""floatField"":[1,1.1],""stringField"":[2,""foobar""],""boolField"":[3,true],""intArrayField"":[6,[3,2,1]],""floatArrayField"":[7,[0,1.2,3.5]],""stringArrayField"":[8,[""cats"",""are"",""cute""]],""boolArrayField"":[9,[false,true]],""objectField"":[5,{""json"":[0,1],},{""json1"":[1,1.2],""json2"":[2,""turtles""],},]}";
